...
import com.neusoft.firstspringboot.vo.ResCode;
import com.neusoft.firstspringboot.vo.ResponseModel;
...
public class FileUpload {
    ...
    @ResponseBody
    public ResponseModel upload(MultipartFile multipartFile, HttpServletRequest request) throws IOException {
        System.out.println("1234556"+multipartFile);
